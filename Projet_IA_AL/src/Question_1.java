...
public class Question_1 {
    ...
    public static MnistReader tdb = new MnistReader(labelTestDB,  imageTestDB);
    ...
    public static void main(String[] args) throws IOException {
    	...
    	FileWriter fw = new FileWriter("NberrValidation en fonction de Na .d");
        for (int Na = 1000; Na <= 10000; Na += 200) {
    	    int ilabel = 0;
            int i = 0;
            int it = 1;
   	      ...
   	      float[][] poids = PerceptronMulti.InitialiseW(longueur * largeur + 1);
              /**Phase d'apprentissage**/
   	        for (int itteration = 0; itteration < itterationMax; itteration++) {
		        ...
		        fw.write( ""+Na+ "    "+ nbErreurValidation +"\n");
